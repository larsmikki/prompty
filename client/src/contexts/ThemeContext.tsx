...
export const THEMES: ThemeDefinition[] = [
  { name: 'Default', mode: 'light', bg: '#f9fafb', surface: '#ffffff', surface2: '#f3f4f6', border: 'rgba(0,0,0,0.06)', text: '#1a1a2e', text2: '#555', accent: '#ea580c', previewColors: ['#f3f4f6', '#e5e7eb', '#ea580c'] },
  ...
  { name: 'Dark', mode: 'dark', bg: '#111827', surface: '#1f2937', surface2: '#374151', border: '#4b5563', text: '#f3f4f6', text2: '#9ca3af', accent: '#f97316', previewColors: ['#2d2d44', '#1e3a5f', '#2d1b4e'] },
...
export function ThemeProvider({ children }: { children: ReactNode }) {
  const [theme, setTheme] = useState<ThemeDefinition>(() => {
    const stored = localStorage.getItem('promptly-theme')
  ...
  useEffect(() => {
    localStorage.setItem('promptly-theme', theme.name)
